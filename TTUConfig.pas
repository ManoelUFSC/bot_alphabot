...
begin
  if Assigned(FConfiguracoes) then begin
    ed_APIKEY1.Text         := FConfiguracoes.APIKey1;
    ed_APIKEY2.Text         := FConfiguracoes.APIKey2;
    ed_APIKEY3.Text         := FConfiguracoes.APIKey3;
    ed_URLConsulta.Text     := FConfiguracoes.URLConsulta;
    ed_URLRegistro.Text     := FConfiguracoes.URLRegistro;
